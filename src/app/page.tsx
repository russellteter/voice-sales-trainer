      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-4">
            <div className="text-xl sm:text-2xl font-black text-class-purple">
              Voice Sales Trainer
            </div>
            <div className="hidden sm:block text-sm text-dark-gray">by Class</div>
          </div>
          ...
          <div className="flex items-center space-x-2">
            {/* Desktop User Info */}
            <div className="hidden sm:block text-sm text-dark-gray mr-2">
            ...
            <button
              ...
              className="md:hidden p-2 rounded-md text-dark-gray hover:text-class-purple transition-colors"
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden border-t border-gray-200 bg-white">
            <nav className="px-2 pt-2 pb-3 space-y-1">
              <div className="px-3 py-2 text-xs text-middle-gray border-b border-gray-100 mb-2">
                Welcome, {user.firstName}
              </div>
              ...
              <button
                ...
                className={`w-full text-left px-3 py-3 text-base font-medium rounded-md transition-colors ${
                  currentScreen === 'dashboard' 
                    ? 'text-class-purple bg-class-pale-purple' 
                    : 'text-dark-gray hover:text-class-purple hover:bg-gray-50'
                }`}
              >
                🎯 Training Scenarios
              </button>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {currentScreen === 'dashboard' && (
          <div>
            ...
            <ErrorBoundary name="ScenarioDashboard">
              <ScenarioDashboard 
        ...
        {currentScreen === 'conversation' && selectedScenario && (
          <ErrorBoundary name="VoiceConversationInterface">
